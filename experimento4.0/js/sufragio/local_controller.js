...
function _cargar_pantalla_lista_completa_segmentada() {
    ...
    if (_segmento_actual === null) {
        ...
        data = local_data.boletas.many({ "segmento": "provincial" });
...
function get_candidatos_boleta(boleta) {
    ...
    for (var i in categorias) {
        ...
        if (
            ...
            if (candidato.categoria.codigo == 'GOB' && categorias.length <= 3) {
                candidato.vice_gob = {
                    nombre: candidato.secundarios[0],
                    asistida: "Vice Gobernador",
                    codigo: "GOB",
                    texto_asistida:  "Vice Gobernador",
                    alto_contraste:  "Vice Gdor.",
                    categoria: "Vice Gdor/ar",
                    imagenes: [candidato.imagenes[1]]
                    }
            }
        }
