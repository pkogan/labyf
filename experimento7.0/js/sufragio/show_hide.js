...
function contenido_solapa(html, datos=null){
    if (datos?.categoria?.nombre === "Cargos Provinciales") {
        patio.categoria_votada_provincial.html(html);
        patio.categoria_votada_provincial.show();
    }
    else if (datos?.categoria?.nombre === "Cargos Municipales") {
        patio.categoria_votada_municipal.html(html);
        patio.categoria_votada_municipal.show();
    }
    else{
