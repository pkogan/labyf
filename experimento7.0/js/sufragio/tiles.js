var pantallas = [
  ...
  {"id": "pantalla_confirmacion",
   ...
   "context_tiles": ["si_confirmar_voto", "no_confirmar_voto",
                     "barra_opciones", "alto_contraste"]
  },
...
var contexto = [
  ...
  {"id": "categoria_votada",
   ...
   "callback_show": function(){
     document.querySelector('#encabezado').classList.add("con-categoria-votada");
   },
   "callback_hide": function(){
     document.querySelector('#encabezado').classList.remove("con-categoria-votada");
   },
  },
  {"id": "categoria_votada_provincial",
   "container": "#contenedor_solapa",
   "callback_show": function(){
     document.querySelector('#encabezado').classList.add("con-categoria-votada");
   },
...
var confirmacion_barra_vertical = [
  {"id": "no_confirmar_voto",
   "template": "no_confirmar_voto",
   "button_filter": "#rechazar_voto",
   "container": "#contenedor_izq",
   "callback_click": click_no
  },
  {"id": "si_confirmar_voto",
   "template": "si_confirmar_voto",
   "button_filter": "#aceptar_voto",
   "container": "#contenedor_izq",
   "callback_click": click_si
  }
];
