...
class Templates {
    ...
    __traer_candidatos_template(candidato, campo, vista) {
        ...
        if (dict_campo != undefined) {
            ...
            // En caso de existir una cantidad específica para el cargo, tomamos esa,
            // de lo contrario, traemos el dato default.
            var cantidad;
            (dict_campo[vista][candidato.cod_categoria])
                ?
                cantidad = dict_campo[vista][candidato.cod_categoria]
                :
                cantidad = dict_campo[vista]["default"];
