 ...
 function set_constants(data){
    ...
    return new Promise((resolve, reject) => {
        ...
        */
         ...
         * @todo: si esto ralentiza la carga, es posible cargarlo sin esperar su complexión, solo 
         * tener en cuenta que el simulador va a tener que manejar este asincronismo antes de 
         * invocar la carga de patio. Por lo demás, la aplicación de voto en sí no deberia tener 
         * inconvenientes.
         */ 
...
function load_templates_sufragio(templates){
    return new Promise((resolve, reject) => {
        if(constants.templates_compiladas){
            const url_templates_flavor = constants.PATH_TEMPLATES_FLAVORS + constants.flavor + "/templates.html";
            ...
            Promise.all([
                ...
                /**
                 * @todo: analizar si es necesario cargar estos templates en el dom.
                 * Si el objetivo de esto es cargarlos en una variable _templates ¿por qué no hacerlo directamente en
                 * lugar de cargarlo en el dom e ir a buscarlos allí luego?.
                */
