...
URL="https://simulador.electoralsalta.gob.ar/"
...
bajar_archivo "imagenes_candidaturas/salta_generales_2023" "BLC.svg"
...
for i in $(jq  '.[].imagenes | unique[]' datos/${IDUBICACION}/Candidaturas.json | sed 's/"//g');
    do
        bajar_archivo "imagenes_candidaturas/salta_generales_2023" "${i}.webp";
    done;
